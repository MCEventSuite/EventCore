...
public class JoinModule extends Module {
    ...
    public void handleJoinEvent(JoinEvent joinEvent){
        if(joinEvent.getPlayer() instanceof PlayerActions){
            PlayerActions playerActions = (PlayerActions) joinEvent.getPlayer();
            playerActions.sendMessage("Welcome!");
            ...
            playerActions.executeAction(giveAction);
        }
    }
