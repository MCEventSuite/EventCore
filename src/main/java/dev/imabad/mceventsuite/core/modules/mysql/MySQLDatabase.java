...
import dev.imabad.mceventsuite.core.modules.eventpass.db.EventPassCode;
...
public class MySQLDatabase extends DatabaseProvider {
    ...
    public void connect() {
        ...
        configuration.addAnnotatedClass(EventPlayerYear.class);
        configuration.addAnnotatedClass(EventYear.class);
        configuration.addAnnotatedClass(EventPassCode.class);
        configuration.addAnnotatedClass(EventPassUnlockedReward.class);
        configuration.addAnnotatedClass(ScavengerLocation.class);
        configuration.addAnnotatedClass(ScavengerHuntPlayer.class);
